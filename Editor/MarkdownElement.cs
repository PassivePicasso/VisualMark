...
using System.IO;
using System.Linq;
using VisualMark.Markdown.Extensions.GenericAttributes;
...
namespace VisualMark.Markdown
{
    ...
    {
        const string MarkdownStylePath = "Packages/com.passivepicasso.visualmark/USS/markdown.uss";
